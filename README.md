...
<head>
    ...
    <link rel="stylesheet" href="index project 01.html>
...
<footer class="bg-dark text-light text-center py-4 mt-5">
  <div class="footer-content">
    <div class="footer-links mb-3">
      <a href="index project 01.html" class="text-light me-3">Home</a>
      <a href="About.html" class="text-light me-3">About Us</a>
      <a href="CONTACT US.html" class="text-light me-3">Contact Us</a>
    </div>
